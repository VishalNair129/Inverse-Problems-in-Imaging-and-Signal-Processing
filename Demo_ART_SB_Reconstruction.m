...
% 
% Demo for an iterative reconstruction method that alternates a
...
% Chamorro-Servent, et al. Use of Split Bregman denoising for
...
% 
%
% This work proposes to combine an iterative solver and denoising steps to
% handle large scale problems in a fast an efficient manner. Here we combine
% Algebraic Reconstruction Technique (ART) and Split Bregman denoising but 
% these methods can be substituted by the method of choice. 
%
...
% load('Data.mat');
% Indeed, the reduced Jacobian matrix (from DataRed), 700x4000, has been
...
% of the data (in this case it converges in 30 iterations), however
% remember that ART is a semiconvergent algorithm
...
for it = 1:numIter
    ...
    % applications for large scale problems  
%     for iz = 1:N(3)
